        ...
        {subjects.length > 0 && (
          <Card>
            ...
            <View style={styles.durationContainer}>
              ...
              />
              <Text
                style={[styles.durationLabel, { color: colors.text.secondary }]}
              >
                minutes
              </Text>
            </View>
        ...
        {selectedSubject && (
          <Card style={styles.previewCard}>
            ...
            <View style={styles.previewItem}>
              <Text
                style={[styles.previewLabel, { color: colors.text.secondary }]}
              >
                Subject:
              </Text>
              <View style={styles.subjectPreview}>
                ...
                />
                <Text
                  style={[styles.previewValue, { color: colors.text.primary }]}
                >
