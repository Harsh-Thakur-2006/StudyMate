        ...
        <Card>
          ...
          {recentSessions.length > 0 ? (
            recentSessions.map(session => (
              <View key={session.id} style={styles.sessionItem}>
                <View style={styles.sessionInfo}>
                  <Text style={[styles.sessionSubject, { color: colors.text.primary }]}>
                    {session.subjectName}
                  </Text>
                  <Text style={[styles.sessionNotes, { color: colors.text.secondary }]}>
                ...
                <Text style={[styles.sessionDuration, { color: colors.success }]}>
            ...
            <Text style={[styles.emptyText, { color: colors.text.tertiary }]}>
              No recent study sessions. Start studying to see your activity here!
            </Text>
          )}
        </Card>
