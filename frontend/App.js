...
function SubjectsStack() {
  return (
    ...
    >
      <Stack.Screen name="SubjectsMain" component={SubjectsScreen} />
      <Stack.Screen name="LogStudy" component={LogStudyScreen} />
    </Stack.Navigator>
  );
}
...
function MainNavigator() {
  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        header: () => {
          ...
          const { title, subtitle } = tabHeaders[route.name] || {
            title: route.name,
            subtitle: "",
          };
    ...
    >
      ...
      <Tab.Screen name="BackendTest" component={BackendTestScreen} />
    </Tab.Navigator>
  );
}
